module BeautifulPhotons
  module PhotoHelper
    ...
    def beautiful_photons_photo(key, **options)
      ...
      return beautiful_photons_placeholder(**options) unless standalone.photo
    ...
    def beautiful_photons_placeholder(**options)
      ...
      content_tag(:div, class: css_class,
        style: "display: flex; align-items: center; justify-content: center; background: #1a1a1a;") do
        content_tag(:svg, xmlns: "http://www.w3.org/2000/svg", fill: "none", viewBox: "0 0 24 24",
          "stroke-width": "0.75", stroke: "#444", class: "bp-placeholder-icon",
